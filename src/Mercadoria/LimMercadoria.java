...
public class LimMercadoria extends JFrame implements ActionListener {
    ...
    JLabel codp, descp, precp, valorvendap, quantip;
        ...
        public LimMercadoria(ctrMercadoria pCtrMercadoria){
            ...
            descp = new JLabel("Descricao: ");
            precp = new JLabel("Preco: ");
        ...
        painel.add(adicionar);
            ...
            //ADICIONA MERCADORIA NOVA
            adicionar.addActionListener(new ActionListener(){
            @Override
                public void actionPerformed(ActionEvent e) {
                       try {
                        CtrMercadoria.insereMercadoria(Integer.parseInt(codigo.getText()), descricao.getText(), Double.parseDouble(preco.getText()), Double.parseDouble(valorVenda.getText()), Integer.parseInt(quantidade.getText()),0);
                        ...
                        JOptionPane.showMessageDialog(null, "Cadastro nao foi efetuado");
                    }
                }});
